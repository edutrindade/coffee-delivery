            ...
            <IntroContent className='container'>
                <div>
                    ...
                    <BenefitsContainer>
                        ...
                        <InfoWithIcon iconBg={colors['brand-yellow']} icon={<Timer weight='fill' />} text='Entrega rápida e rastreada' />
                        <InfoWithIcon iconBg={colors['brand-purple']} icon={<Coffee weight='fill' />} text='O café chega fresquinho até você' />
                    </BenefitsContainer>
                </div>
